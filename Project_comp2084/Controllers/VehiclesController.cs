...
namespace Project_comp2084.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var trans = _context.Client.Where(p => p.VehicleId == id).OrderBy(packs => packs.ClientId);
            var viewModal = new VehicleViewModel()
            {
                type = vehicle.type,
                Id = vehicle.Id,
                Cost = vehicle.Cost,
        ...
        public async Task<IActionResult> Create([Bind("Id,type,Cost")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,type,Cost")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
